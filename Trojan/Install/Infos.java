 ...
 * @Last modified time: 2017-10-21T12:34:51+02:00
 * @License:            MIT
...
public class Infos {
  ...
  */
  public String toString() {
      ...
      stringBuilder.append("\t      " + "OS name ### " + this.os_name + "\n");
      stringBuilder.append("\t      " + "Host name ### " + this.host_name + "\n");
      stringBuilder.append("\t      " + "OS architecture ### " + this.os_arch + "\n");
      stringBuilder.append("\t      " + "OS version ### " + this.os_version + "\n");
      stringBuilder.append("\t      " + "User name ### " + this.user_name + "\n");
