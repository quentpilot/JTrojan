...
# @Last modified time:  2017-10-19T16:40:33+02:00
# @License:             MIT
...
javadoc -d $pwd/resources/javadoc/www/ -cp '.:resources/lib/gson-2.8.0.jar:resources/lib/json-20140107.jar:resources/lib/httpcore-4.4.7.jar:resources/lib/httpclient-4.5.3.jar:resources/lib/commons-logging-1.2.jar' $pwd/resources/javadoc/*/**.java
...
rm -r $pwd/resources/javadoc/Installer
